...
# Bot information
SESSION = environ.get('SESSION', 'justfilesharebot')
API_ID = int(environ.get('API_ID', '26258063'))
API_HASH = environ.get('API_HASH', 'be0a0e2ecd938bfc5401d35a399deeb7')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7537072860 6883721620').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002284275363'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001933477841').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002190021343') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002394313749')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dheerajsharma1316:2RIA8lR5sHRlDaxh@cluster0.sv7jok6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+FDaQcCjYu-1iN2E1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+FDaQcCjYu-1iN2E1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'FDaQcCjYu-1iN2E1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/+FDaQcCjYu-1iN2E1')
